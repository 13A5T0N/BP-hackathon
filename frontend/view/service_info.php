        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-dark">
                    <form action="../../php/actuator.php" method="POST">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="exampleInputEmail1" value="<?php $service->name($conn)?>" placeholder="<?php $service->name($conn)?>" disabled">
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" value="Save changes" name="service_rating" class="btn btn-primary">
                </div>
                </form>
            </div>
        </div>
